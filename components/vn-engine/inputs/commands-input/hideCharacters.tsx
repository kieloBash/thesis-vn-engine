...
const HideCharacterInput = () => {
  ...
  useEffect(() => {
    if (
      ...
      isHideCharacterCommand(selectedSlide.dialogue)
    ) {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    if (
      ...
      isHideCharacterCommand(newSlides[selectedIdx].dialogue)
    ) {
      let newData = {
        ...newSlides[selectedIdx].dialogue,
        speakers,
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 z-10 bg-white h-14 border-b w-full flex justify-between items-center p-4">
        <h3 className="font-medium text-lg">COMMAND: Hide Characters</h3>
...
export default HideCharacterInput;
